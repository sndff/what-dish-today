...
public final class FragmentHomeAllBinding implements ViewBinding {
  ...
  private FragmentHomeAllBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static FragmentHomeAllBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentHomeAllBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_home_all, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentHomeAllBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentHomeAllBinding((RelativeLayout) rootView, rvMainCategory, rvSubCategory,
          tvAll, tvMustTry);
    }
