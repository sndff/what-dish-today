...
public final class FragmentHomeDagingBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentHomeDagingBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static FragmentHomeDagingBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentHomeDagingBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_home_daging, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentHomeDagingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentHomeDagingBinding((RelativeLayout) rootView, rvMainCategory, rvSubCategory,
          tvAll, tvMustTry);
    }
