...
public final class FragmentHomeSopBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentHomeSopBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static FragmentHomeSopBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentHomeSopBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_home_sop, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentHomeSopBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentHomeSopBinding((RelativeLayout) rootView, rvMainCategory, rvSubCategory,
          tvAll, tvMustTry);
    }
