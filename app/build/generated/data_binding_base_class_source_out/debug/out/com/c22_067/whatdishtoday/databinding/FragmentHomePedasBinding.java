...
public final class FragmentHomePedasBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentHomePedasBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static FragmentHomePedasBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentHomePedasBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_home_pedas, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentHomePedasBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentHomePedasBinding((RelativeLayout) rootView, rvMainCategory, rvSubCategory,
          tvAll, tvMustTry);
    }
