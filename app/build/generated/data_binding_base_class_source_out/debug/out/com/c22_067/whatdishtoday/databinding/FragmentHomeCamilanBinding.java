...
public final class FragmentHomeCamilanBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentHomeCamilanBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static FragmentHomeCamilanBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentHomeCamilanBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_home_camilan, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentHomeCamilanBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentHomeCamilanBinding((RelativeLayout) rootView, rvMainCategory,
