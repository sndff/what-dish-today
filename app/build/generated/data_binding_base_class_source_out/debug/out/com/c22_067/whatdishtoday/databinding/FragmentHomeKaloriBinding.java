...
public final class FragmentHomeKaloriBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentHomeKaloriBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static FragmentHomeKaloriBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentHomeKaloriBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_home_kalori, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentHomeKaloriBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentHomeKaloriBinding((RelativeLayout) rootView, rvMainCategory, rvSubCategory,
          tvAll, tvMustTry);
    }
